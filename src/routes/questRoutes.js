...
router.post("/accept",questController.checkQuestAndCharacterId,questController.checkAlrCompleted,questController.checkCharacterLevel,questController.getDataForbattlefield,questController.addRewards); 
